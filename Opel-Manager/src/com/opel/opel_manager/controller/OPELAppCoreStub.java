...
//        }
//
//        OPELContext.getAppList().installApplication(new OPELApplication
//                (appID, appName, bitmap, 0));
//
//        //AppMarketActivity release
//        AppMarketActivity.marketProgDialog.dismiss();
//        updateMainUIThread(HANDLER_UPDATE_UI);
//        updateMainUIThread(HANDLER_UPDATE_TOAST, "Complete the installation
// :" +
//                " " + appName);
//
//        try {
...
//            File pkgFile = new File(downloaddir, jp.getValueByKey
//                    ("pkgFileName"));
//            pkgFile.delete();
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
    ...
    void handleUpdateAppInfomation(JSONParser jp) {
        ...
        while (jp.hasMoreValue()) {
            ...
            String fileName = ret[0].substring(0, ret[0].length() - 2) + "" +
                    ".icon";
            ...
            int type = Integer.parseInt(ret[0].substring(ret[0].length() - 1,
                    ret[0].length()));
    ...
    void handleUninstall(JSONParser jp) {
        ...
        OPELApplication deleteTargetApp = OPELContext.getAppList().getApp
                (appID);
    ...
    void handleStart(JSONParser jp) {
        ...
        updateMainUIThread(HANDLER_UPDATE_UI);
        updateMainUIThread(HANDLER_UPDATE_TOAST, "Run OPELApplication : " +
                OPELContext.getAppList().getApp(appID).getTitle());
    }
    ...
    void handleEventWithNoti(JSONParser jp) {
        ...
        OPELContext.getEventList().addEvent(jp.getValueByKey("appID"), jp
                .getValueByKey("appTitle"), jp.getValueByKey("description"),
                jp.getValueByKey("dateTime"), jp.getJsonData());
...
//        return rcvFile(OPELContext.getSettings().getRemoteStorageDir(), jp);
    ...
    void handleCloudService(JSONParser jp) {
        ...
        try {
            ...
            File fd = new File(OPELContext.getSettings().getCloudDir(), jp
                    .getValueByKey("img"));
...
//				meta += "!";
    ...
    public void requestTermination(String appID) {
        ...
        String terminationJson = OPELContext.getAppList().getApp(appID)
                .getTerminationJson();
