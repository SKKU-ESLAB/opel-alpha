...
//            Bitmap bitmap = null;
//
//            String mFileName = ret[0].substring(0, ret[0].length() - 2) + "" + ".icon";
//            File f = new File(OPELContext.getSettings().getIconDir(), mFileName);
//
//            BitmapFactory.Options options = new BitmapFactory.Options();
//            options.inPreferredConfig = Bitmap.Config.ARGB_8888;
//
...
//        String mFileName = jp.getValueByKey("mFileName");
...
////        try {
////
////            File fd = new File(OPELContext.getSettings().getCloudDir(), jp.getValueByKey
/// ("img"));
...
//
//
//    public void requestInstall(String mFileName) {
...
//        jp.addJsonKeyValue("pkgFileName", mFileName);
//
