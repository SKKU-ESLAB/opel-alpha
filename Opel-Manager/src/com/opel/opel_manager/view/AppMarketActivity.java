    ...
    private class webViewClient extends WebViewClient {
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.endsWith("opk")) {
                ...
                while (new File(Environment.DIRECTORY_DOWNLOADS, fileName)
                        .exists()) {
                    fileName += "_";
                }
                ...
                DownloadManager.Request request = new DownloadManager.Request
                        (source);
                request.setDescription("Description for the DownloadManager "
                        + "Bar");
                ...
                //request.setDestinationInExternalPublicDir(appPackagePath,
                // fileName);
                //request.setDestinationInExternalFilesDir
                // (getApplicationContext(), OPELContext.get().getStoragePath
                // (), fileName);
        ...
        public void onReceive(Context arg0, Intent arg1) {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (status == DownloadManager.STATUS_SUCCESSFUL) {
                    ...
                    try {
                        ParcelFileDescriptor file = manager
                        ...
                        class thth extends Thread {
                            ...
                            public void run() {
                                OPELContext.getAppCore().requestInstall
                                        (filename);
                            }
                        }
