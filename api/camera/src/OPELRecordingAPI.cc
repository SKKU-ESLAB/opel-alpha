...
DBusMessage* OPELRecording::sendSensorOverlayDbusMsg(const char* msg,
...
NAN_METHOD(OPELRecording::sensorOverlayStart)
{
  OPELRecording *recObj = Nan::ObjectWrap::Unwrap<OPELRecording>(info.This());
...
NAN_METHOD(OPELRecording::sensorOverlayStop)
{
  OPELRecording *recObj = Nan::ObjectWrap::Unwrap<OPELRecording>(info.This());
  dbusSensorOverlayRequest *dbus_request = NULL; 
  DBusMessage *message;
